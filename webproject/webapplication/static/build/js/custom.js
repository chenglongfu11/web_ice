...
function init_echarts() {
    ...
    if ($('#echart_line_celec1').length) {
        var echartids = ['echart_line_celec1', 'echart_line_cfuel', 'echart_line_chotwater',
            'echart_line_chvac', 'echart_line_cequip', 'echart_line_clight', 'echart_line_sum'];
        var jListids = ['{{cElec | safe}}', '{{cFuel | safe}}', '{{cHotWater | safe}}',
            '{{cHvac | safe}}', '{{cEquip | safe}}', '{{cLight | safe}}', '{{cSum | safe}}'];
        var names = ['Electric Cooling', 'Fuel Heating', 'Domestic Hot Water', 'HVAC', 'Equipment, Tenant',
            'Lighting Facility', 'Sum of All'];
        console.log(names);
