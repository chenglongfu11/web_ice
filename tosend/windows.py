...
"""
    Question: I tried to clone a window from one wall to the other wall, it doesn't work well because the geometry is different.
    
    Is it possible to create a window object directly via API?
